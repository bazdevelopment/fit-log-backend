...
exports.cleanUnverifiedOtpAccountsController =
  exports.refreshTokenController =
  exports.resetPasswordController =
  exports.forgotPasswordController =
  exports.verifyOtpCodeController =
  exports.resendOtpCodeController =
 ...
 */
const signUpController = (request, reply) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, mail_1.sendOtpCodeMail)({
      ...
      htmlTemplate: (0, sendOtpCodeTemplate_1.sendOtpCodeTemplate)(
        firstName,
        otpCode
      ),
    });
    return reply.code(201 /* HTTP_STATUS_CODE.CREATED */).send(
      (0, httpResponse_1.createSuccessResponse)({
 ...
 */
const signInController = (request, reply) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isPasswordMatching = (0, hash_1.verifyHashedField)(
      password,
      registeredUser.salt,
    ...
    const { accessToken, refreshToken } = (0, generate_tokens_1.generateTokens)(
      {
        ...
        expiresAccessToken:
          environment_variables_1.environmentVariables.authentication
    ...
    return reply
      ...
      .setCookie(
        "refresh_token",
        refreshToken !== null && refreshToken !== void 0 ? refreshToken : "",
        auth_constants_1.tokenCookieOptions
      )
      .send(
        (0, httpResponse_1.createSuccessResponse)({
          status: 201 /* HTTP_STATUS_CODE.CREATED */,
 ...
 */
const resendOtpCodeController = (request, reply) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { email } = request.body;
    const newOtpCode = (0, generateUniqueOtpCode_1.generateOTPCode)();
    const { hash: hashNewOtpCode, salt: saltNewOtpCode } = (0,
    hash_1.hashField)(newOtpCode);
    ...
    return reply.code(200 /* HTTP_STATUS_CODE.OK */).send(
      (0, httpResponse_1.createSuccessResponse)({
        status: 200 /* HTTP_STATUS_CODE.OK */,
 ...
 */
const verifyOtpCodeController = (request, reply) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isOtpMatching = (0, hash_1.verifyHashedField)(
      otpCode,
      user.saltOtp,
      user.otpCode
    );
    const isOtpExpired =
      new Date() >
      new Date(user === null || user === void 0 ? void 0 : user.otpExpiration);
 ...
 * */
const forgotPasswordController = (request, reply) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { email } = request.body;
    const user = yield (0, auth_services_1.getUserByEmail)(email);
    if (!user) {
    ...
    const userUpdated = yield (0, auth_services_1.updatePasswordResetToken)({
      ...
      computeFutureTimestamp_1.computeFutureTimestamp)(10),
    });
    yield (0, mail_1.sendOtpCodeMail)({
      receiverEmail: email,
      subject: "Forgot password",
      htmlTemplate: (0,
      forgotPasswordTemplate_1.generateForgotPasswordTemplate)(
    ...
    return reply.code(201 /* HTTP_STATUS_CODE.CREATED */).send(
      (0, httpResponse_1.createSuccessResponse)({
        status: 201 /* HTTP_STATUS_CODE.CREATED */,
        message:
          "You will receive a reset code email. Please verify your inbox!",
      })
    );
  });
 ...
 * */
const resetPasswordController = (request, reply) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const refreshTokenController = (request, reply) => {
  try {
    ...
    const { accessToken: newAccessToken } = (0,
    generate_tokens_1.generateTokens)({
      request,
      userInfo: {
 ...
 */
const cleanUnverifiedOtpAccountsController = (_request, reply) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      yield (0, auth_services_1.cleanUnverifiedOtpAccounts)();
      reply.code(202 /* HTTP_STATUS_CODE.ACCEPTED */).send(
        (0, httpResponse_1.createSuccessResponse)({
          status: 201 /* HTTP_STATUS_CODE.CREATED */,
