...
function buildServer() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    app.register(jwt_1.default, {
      secret:
        environment_variables_1.environmentVariables.authentication.jwtSecret,
    });
     ...
     */
    (0,
    registerSchemas_1.registerSchemas)(app, [...auth_schemas_1.authSchemas, ...user_schemas_1.userSchemas, ...exercise_schemas_1.exerciseSchemas]);
    ...
    app.register(exercise_routes_1.exerciseRoutes, {
